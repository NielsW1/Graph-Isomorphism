from src.graphs.modules import graph
from src.graphs.modules.graph_io import load_graph, write_dot  # graphIO import graphs.py, so we do not need to import it here.
import os
import math
